...
/// </summary>
public class MemberMaster implements Parcelable {
    ...
    public static final Creator<MemberMaster> CREATOR = new Creator<MemberMaster>() {
        public MemberMaster createFromParcel(Parcel source) {
...
//             source.readList(objMemberMaster.lstMemberRelativeTran,null);
        ...
        public MemberMaster[] newArray(int size) {
            return new MemberMaster[size];
        }
    };
